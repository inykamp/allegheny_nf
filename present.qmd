...
Currently, nearly 50% of the Allegheny National Forest is dominated by the Appalachian Northern Hardwood Forest, followed by nearly 25% of the area being dominated by Appalachian (Hemlock-)Northern Hardwood Forest. 

These biophysical settings are differentiated by the mixture of conifer & hardwood within the Appalachian (Hemlock-)Northern Hardwood Forest and dominance of hardwoods within the Appalachian Northern Hardwood Forest.

This existing vegetation cover is dominated by 70-79% tree cover, followed by 60-69% tree cover dominating 30% and 25% of the landscape respectively.

45% of existing vegetation heights are around 20 - 25 m with nearly another 40% of vegetation heights just below that at 15-20 meters. 
...
evtChart <-
  ...
  labs(
    title = "Top 6 Existing Vegetation Types",
