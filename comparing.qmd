...
Hardwoods continue to dominate through the Allegheny National Forest shrinking down from 575,000 acres to 390,000 acres, and gave way to 
majority of the current Conifer-Hardwood Forest, Conifer Forest, Developed land, Agricultural, and Exotics. 
...
Appalachian (Hemlock-)Northern Hardwood Forest was primarily sucession class D, but currently is split between class B & C.

Central Appalachian Dry Oak-Pine Forest was primarily within class D in the past but today, it is primarily within class C. 

Central Interior and Appalachian Riparian Systems trended towards class D, but currently are spread throughout succession classes, primarily C and B.
